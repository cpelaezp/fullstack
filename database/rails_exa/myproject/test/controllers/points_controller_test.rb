...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { iduser: @point.iduser, postlatitud: @point.postlatitud, postlongitud: @point.postlongitud } }, as: :json
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { iduser: @point.iduser, postlatitud: @point.postlatitud, postlongitud: @point.postlongitud } }, as: :json
    assert_response 200
  end
